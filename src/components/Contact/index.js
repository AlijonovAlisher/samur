    ...
    <>
      <div className="container contact-page">
        ...
        <div className="map-wrap">
          ...
          <MapContainer center={[39.6543, 66.9501]} zoom={13}>
            <TileLayer url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" />
            <Marker position={[39.6543, 66.9501]}>
              <Popup>
                Welcome to Botir Zokirov Mahalla in Samarkand! Enjoy your visit. 😊
              </Popup>
            </Marker>
          </MapContainer>
        </div>
